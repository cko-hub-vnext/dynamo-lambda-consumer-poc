...
aws --endpoint-url=http://localhost:4574 lambda create-function \
    ...
    --zip-file filec:///Development//SearchPopulator.Lambda.PoC//src//SearchPopulator.Lambda.PoC//bin//Release//netcoreapp2.1//SearchPopulator.Lambda.PoC.zip \
    --handler SearchPopulator.Lambda.PoC::SearchPopulator.Lambda.PoC.Function::FunctionHandler \
    --role local-role
